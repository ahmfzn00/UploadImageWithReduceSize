...
//            )
    ...
    private fun uploadImage() {
        if (getFile != null){
            ...
            val desc = "Ini adalah deskripsi gambar".toRequestBody("text/plain".toMediaType())
            ...
            uploadService(imageMultipart, desc)

        } else {
            Toast.makeText(this@MainActivity, "Silahkan masukkan gambar", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun uploadService(imageMultipart: MultipartBody.Part, desc: RequestBody) {
        val service = ApiConfig().getApiService().uploadImage(imageMultipart, desc)
